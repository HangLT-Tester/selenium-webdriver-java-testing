...
public class Topic_02_Xpath_Css_Part_I_Locator {
	...
	public void beforeClass() {
		...
		//Thời gian để chờ cho element được tìm thấy trong 1 khoảng time (30s)
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		sleepInSecond(3);
		
		// Mở AUT/ SUT (trang rigister)
	...
	public void TC_03_Name() {
		...
		driver.findElement(By.name("Email")).sendKeys("lehang@gmail.com");
		sleepInSecond(3);
	...
	public void TC_07_Css() {
		...
		driver.findElement(By.cssSelector("input[name='Email']")).sendKeys("lehang@gmail.com");
		sleepInSecond(3);
	...
	public void TC_08_Xpath() {
		...
		driver.findElement(By.xpath("//input[@name='Email']")).sendKeys("lehang@gmail.com");
		sleepInSecond(3);
